...
const SLIDESHOW_BACKGROUNDS = [
  "/assets/backgrounds/bg_cyber_kente.png",
  "/assets/backgrounds/bg_accra_cyber.png",
  "/assets/backgrounds/bg_black_star.png",
  "/assets/backgrounds/bg_quantum_mesh.png",
  ...
  "/assets/backgrounds/bg_world_cup_stadium.png",
  "/assets/backgrounds/bg_world_cup_abstract.png",
];

export const TraditionalBackground = memo(({ className = "fixed inset-0 z-20 opacity-[0.35] dark:opacity-[0.45] pointer-events-none" }: { className?: string }) => {
