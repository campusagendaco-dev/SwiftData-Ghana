...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* ── Top Greeting Bar ── */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-card-neo p-4 sm:p-5 rounded-3xl border border-white/10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {quickActions.map((a) => (
            <button
              ...
              className="glass-card-neo p-4 rounded-2xl border border-white/10 hover:border-amber-500/40 flex flex-col items-start gap-3 transition-all text-left group"
            >
