...
const DashboardResultCheckers = () => {
  ...
  if (successData) {
    ...
    return (
      <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6 animate-in zoom-in-95 duration-300">
        ...
        <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-3xl p-5 grid grid-cols-2 md:grid-cols-4 gap-4 shadow-sm text-sm">
          <div>
          ...
          {vouchersList.length > 0 ? (
            <div className="space-y-3 max-h-[420px] overflow-y-auto pr-1">
              {vouchersList.map((v: any, i: number) => {
                ...
                return (
                  <div key={i} className="p-4 rounded-2xl bg-secondary/40 dark:bg-slate-900/80 border border-border dark:border-slate-800 space-y-2.5 group hover:border-emerald-500/40 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs font-mono">
                      <div className="flex items-center justify-between bg-card dark:bg-slate-950 p-3 rounded-xl border border-border dark:border-slate-800">
                        <div className="truncate mr-2">
                          <span className="font-sans text-[10px] font-bold text-muted-foreground uppercase mr-2 block">SERIAL:</span>
                      ...
                      <div className="flex items-center justify-between bg-card dark:bg-slate-950 p-3 rounded-xl border border-border dark:border-slate-800">
                        <div className="truncate mr-2">
                          <span className="font-sans text-[10px] font-bold text-muted-foreground uppercase mr-2 block">PIN:</span>
                    ...
                    <div className="flex items-center justify-between bg-card dark:bg-slate-950 p-3 rounded-xl border border-border dark:border-slate-800 text-xs font-mono">
                      <div className="truncate mr-2">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between p-4 rounded-2xl bg-secondary/40 dark:bg-slate-900/80 border border-border dark:border-slate-800 text-xs font-bold gap-2">
          <div>
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl space-y-8 animate-in fade-in duration-500 mx-auto">
      ...
      {/* Modern Hero Header */}
      <div className="relative overflow-hidden rounded-3xl border border-border dark:border-slate-800 bg-gradient-to-br from-card via-card to-amber-500/5 dark:from-slate-900 dark:via-slate-900/90 dark:to-amber-500/10 p-6 md:p-8 shadow-sm">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="bg-card/90 dark:bg-slate-800/80 border border-border dark:border-slate-700/80 rounded-2xl p-4 flex items-center gap-4 shrink-0 shadow-sm backdrop-blur-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8">
        ...
        <div className="rounded-3xl border border-border dark:border-slate-800 bg-card/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 md:p-8 space-y-8 shadow-sm">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : "border-border dark:border-slate-800 bg-card/40 dark:bg-slate-950/40 text-muted-foreground hover:text-foreground hover:border-border/80"
                    )}
                  >
                    {v.badge && (
                      <span className={cn(
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-border/50 dark:border-slate-800/80">
                      ...
                      {pricesLoading ? (
                        ...
                        <span className="font-black text-base text-foreground bg-secondary/60 dark:bg-slate-800/80 px-3 py-1 rounded-xl border border-border dark:border-slate-700 font-mono">
                          ₵{v.price.toFixed(2)}
                        </span>
                      )}
                    </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-13 pl-11 pr-4 bg-secondary/40 dark:bg-slate-950/60 border border-border dark:border-slate-800 rounded-2xl text-sm font-black focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-mono text-foreground"
              />
            </div>
          ...
          <div className="space-y-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    parseInt(quantity, 10) === q
                      ...
                      : "bg-secondary/60 dark:bg-slate-800/60 text-muted-foreground border-border dark:border-slate-700/60 hover:bg-secondary dark:hover:bg-slate-800 hover:text-foreground"
                  )}
                >
                  {q === 1 ? "Single (1)" : `Bulk (${q})`}
                </button>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-13 h-13 rounded-2xl bg-secondary dark:bg-slate-800 border border-border dark:border-slate-700 flex items-center justify-center text-foreground dark:text-slate-100 hover:bg-secondary/80 font-black text-lg transition-colors shrink-0"
              >
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-13 pl-11 pr-4 bg-secondary/40 dark:bg-slate-950/60 border border-border dark:border-slate-800 rounded-2xl text-base font-black text-center focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-mono text-foreground"
                />
              </div>
        ...
        <div className="space-y-6">
          ...
          {/* Summary Breakdown */}
          <div className="rounded-3xl border border-border dark:border-slate-800 bg-card/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 space-y-5 shadow-sm">
            <h3 className="font-black text-foreground text-lg border-b border-border/50 dark:border-slate-800 pb-3">Order Summary</h3>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="pt-4 border-t border-border dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="rounded-2xl border border-border dark:border-slate-800 bg-card/60 dark:bg-slate-900/60 backdrop-blur-sm p-5 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
            ...
            {totalCost > 0 && walletBalance !== null && !walletLoading && (
              <div className="pt-3 border-t border-border/50 dark:border-slate-800/80 flex items-center justify-between text-xs font-bold">
          ...
          <div className="bg-card/40 dark:bg-slate-900/40 border border-border dark:border-slate-800 rounded-2xl p-4 flex items-center gap-3">
      ...
      <div className="rounded-3xl border border-border dark:border-slate-800 bg-card/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 md:p-8 space-y-5 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-secondary dark:bg-slate-800 text-xs font-bold text-muted-foreground hover:text-foreground transition-colors"
          >
        ...
        {ordersLoading ? (
          ...
          <div className="space-y-3">
            {recentOrders.map((order) => {
              ...
              return (
                <div key={order.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-secondary/20 dark:bg-slate-900/60 border border-border/50 dark:border-slate-800 hover:border-border transition-all">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0 border-t sm:border-t-0 pt-2 sm:pt-0 border-border/40 dark:border-slate-800/80">
      ...
      {selectedPastVouchers && (
        <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-3xl p-6 max-w-2xl w-full space-y-5 shadow-2xl animate-in zoom-in-95 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              {selectedPastVouchers.vouchers.map((v: any, i: number) => {
                const combinedStr = `SERIAL: ${v.serial} | PIN: ${v.pin}`;
                return (
                  <div key={i} className="p-4 rounded-2xl bg-secondary/40 dark:bg-slate-950/60 border border-border dark:border-slate-800 space-y-2 text-xs font-mono">
                    <div className="text-[10px] font-bold text-muted-foreground uppercase">Voucher {i + 1}</div>
                    <div className="flex justify-between items-center bg-card dark:bg-slate-900 p-2.5 rounded-xl border border-border dark:border-slate-800">
