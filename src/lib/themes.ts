...
export const THEMES: AppTheme[] = [
  {
    ...
    dot: "#10b981",
    primary: "142 76% 45%",
    bodyGradient: "radial-gradient(ellipse at 25% 0%, #061c0e 0%, #010603 60%)",
    glassRgb: "4,15,8",
    glassBorder: "16,185,129",
    isLight: false,
    heroHex: "#031008",
  },
  {
    ...
    dot: "#eab308",
    primary: "47 95% 50%",
    bodyGradient: "radial-gradient(ellipse at 25% 0%, #1c1303 0%, #050300 60%)",
    glassRgb: "20,15,5",
    glassBorder: "234,179,8",
    isLight: false,
    heroHex: "#110b01",
  },
  {
    ...
    dot: "#ef4444",
    primary: "0 84% 60%",
    bodyGradient: "radial-gradient(ellipse at 25% 0%, #220505 0%, #060101 60%)",
    glassRgb: "25,5,5",
    glassBorder: "239,68,68",
    isLight: false,
    heroHex: "#140303",
  },
  {
    id: "worldcup_stadium",
    label: "Stadium Lights 🏟️",
    dot: "#06b6d4",
    primary: "199 89% 48%",
    bodyGradient: "radial-gradient(ellipse at 25% 0%, #031b2f 0%, #01060c 60%)",
    glassRgb: "3,15,30",
