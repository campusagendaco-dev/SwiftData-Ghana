-- Migration: Add active_payment_gateway to system_settings and v_system_settings_with_secrets view
ALTER TABLE public.system_settings ADD COLUMN IF NOT EXISTS active_payment_gateway TEXT NOT NULL DEFAULT 'paystack';
