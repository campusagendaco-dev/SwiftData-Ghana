-- Migration: Fix Daily SMS Comma Separated Recipients
-- Description: Redefines the public.broadcast_push_notification function to aggregate recipient phone numbers into a comma-separated string instead of a JSON array, as required by the TxtConnect API parameters validation.
...
BEGIN
  ...
  -- Aggregate normalized phone numbers as a comma-separated string
