...
-- Update handle_new_user function to store device_id from metadata
...
-- Create helper function to check if device is blocked (associated with suspended account)
...
GRANT EXECUTE ON FUNCTION public.check_device_blocked(TEXT) TO anon, authenticated;
