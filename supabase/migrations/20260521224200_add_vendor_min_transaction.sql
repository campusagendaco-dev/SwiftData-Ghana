-- Add vendor_min_transaction to system_settings
ALTER TABLE public.system_settings ADD COLUMN IF NOT EXISTS vendor_min_transaction DECIMAL DEFAULT 1.00;

-- Recreate the public_system_settings view to include the new field
