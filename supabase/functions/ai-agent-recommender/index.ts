...
// Runs every 6 hours
Deno.cron("Agent Profit Recommender", "0 */6 * * *", async () => {
  console.log("Running AI Agent Profit Recommender...");
  ...
  console.log(`Agent Profit Recommender finished. Generated ${recommendationsGenerated} recommendations.`);
});

serve(async (req) => {
  return new Response(JSON.stringify({ status: "AI Agent Recommender is active." }), {
